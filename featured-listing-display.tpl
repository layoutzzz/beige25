<tr>
	...
	<div class="stat">({$lang.clicks}: {$listing.clicks};
		...
		{if $config.broken_listings_report && not ($esynAccountInfo.id eq $listing.account_id)}
			<a href="#" class="esynactions|broken|{$listing.id}" rel="nofollow">{print_img fl="report_16.png" full=true alt=$lang.report_broken_listing title=$lang.report_broken_listing}</a>
		{/if}
